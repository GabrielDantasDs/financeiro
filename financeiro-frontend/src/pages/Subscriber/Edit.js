...
import { get, update } from "../../cruds/subscriber";
...
export default function Edit() {
  ...
  const getIniitalState = () => {
    return {
      ...
      sub_document: subscriber.sub_document ?? "",
      sub_phone: subscriber.sub_phone ?? "",
      sub_address: subscriber.sub_address ?? "",
      sub_district: subscriber.sub_district ?? "",
      sub_state: subscriber.sub_state ?? "",
      sub_number: subscriber.sub_number ?? "",
      sub_city: subscriber.sub_city ?? "",
      sub_type: subscriber.sub_type ?? "",
      sub_zip_code: subscriber.sub_zip_code ?? "",
          ...
          <>
            <div className="header">
              <h1 className="list_title">
                Fornecedor/Cliente: Novo Fornecedor/Cliente
              </h1>
            </div>
            <div className="form">
              <Formik
                    ...
                    <div className="form-row">
                      <div className="form-group col-md-6">
                        <TextField
                          ...
                          error={
                            touched.sub_name && errors.sub_name ? true : false
                          }
                          name="sub_name"
                          onBlur={handleBlur}
                          fullWidth
                    ...
                    <div className="form-row">
                      <div className="form-group col-md-6">
                        <TextField
                          ...
                          error={
                            touched.sub_city && errors.sub_city ? true : false
                          }
                          onBlur={handleBlur}
                          onChange={handleChange}
                        />
                    ...
                    <div className="form-row">
                      <div className="form-group col-md-6">
                        <TextField
                          ...
                          error={
                            touched.sub_address && errors.sub_address
                              ? true
                              : false
                          }
                          onBlur={handleBlur}
                      ...
                      <div className="form-group col-md-6">
                        <TextField
                          ...
                          error={
                            touched.sub_number && errors.sub_number
                              ? true
                              : false
                          }
                          onBlur={handleBlur}
